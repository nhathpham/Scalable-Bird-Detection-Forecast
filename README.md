...
We built accurate and scalable times series models to forecast weekly detection rates of 465 species in each of 14 Massachussetts (MA) counties, and descriptive analyses to recommendations optimal locations and times. Results are presented on an interactive Tableau dashboard.
...
- *Initial testing*: evaluated several time series forecasting models on a sample of 50 species (700 models). Narrowed down to Prophet and Silverkite for performance and scalability
- *Compare Silverkite and Prophet*:
...
- *Tune parameters for both models* via grid search, cross-validation, and parallel processing
- *Final choice*: Prophet due to efficiency and comparable accuracy
